...
- (void)prepare
{
    ...
    /*
     "MJRefreshBackFooterIdleText" = "上拉加载";
     "MJRefreshBackFooterPullingText" = "释放加载";
     "MJRefreshBackFooterRefreshingText" = "加载中...";
     "MJRefreshBackFooterNoMoreDataText" = "我是有底线的";
     */
    // 初始化文字
...
//    [self setTitle:[NSBundle mj_localizedStringForKey:MJRefreshBackFooterNoMoreDataText] forState:MJRefreshStateNoMoreData];
    ...
    [self setTitle:@"喵喵，到底咯！" forState:MJRefreshStateNoMoreData];
}
