...
- (void)setNeedsNavigationBarUpdateForShadowImageHidden:(BOOL)hidden {
    self.navigationBar.shadowImage = (hidden == YES) ? [UIImage createImageWithColor:[UIColor colorWithWhite:0 alpha:0]] : [UIImage createImageWithColor:UIColorRGB(233, 233, 233)];
}
